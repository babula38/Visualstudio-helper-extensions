...
namespace VSIXProject1
{
    ...
    internal sealed class FirstCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("d00198c3-98fd-4ae7-a026-9bedec7f305b");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            if (dte.ActiveDocument != null)
            {
                ...
                string[] textToken = text.ToLowerInvariant().Split(' ');
                string underScoredText = string.Join("_", textToken);
                // Modify the text, for example:
                //text = ">>" + text + "<<";

                // Replace the selection with the modified text.
                selection.Text = underScoredText;
            }
